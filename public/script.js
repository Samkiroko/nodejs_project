    ...
    datasets: [
      {
        ...
        borderColor: '#413830',
        tension: 0.1,
        pointBackgroundColor: '#413830',
        pointBorderColor: '#fff',
        pointHoverBackgroundColor: '#fff',
        pointHoverBorderColor: '#413830',
      },
      {
...
function displayEntries(entries) {
  ...
  entries.forEach((entry) => {
    ...
    entryDiv.textContent = `Sales: ${entry.price}, Date: ${new Date(
      entry.date
    ).toLocaleDateString()}`;
