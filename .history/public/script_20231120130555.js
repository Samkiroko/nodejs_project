...
//       // Update chart title to the item's name
//       myChart.data.datasets[0].label = currentName;
...
//         div.textContent = `Price: ${entry.price}, Date: ${new Date(
//           entry.date
//         ).toLocaleDateString()}`;

//         // Use timestamp as identifier
//         let entryTimestamp = entry.date;
...
//           // Populate the editEntryForm with current data
//           document.getElementById('editEntryPrice').value = entry.price;
//           document.getElementById('editEntryDate').value = new Date(
//             entryTimestamp
//           )
//             .toISOString()
//             .split('T')[0]; // Format date to YYYY-MM-DD

//           // Show the editEntryForm modal
//           $('#editEntryModal').modal('show');

//           // Save the IDs for later use
//           currentEntryId = entryTimestamp; // Use timestamp as the identifier
...
//           deleteEntry(itemId, entryTimestamp);
//         };
